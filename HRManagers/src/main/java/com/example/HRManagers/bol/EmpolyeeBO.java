...
import com.example.HRManagers.ConvertData;
import com.example.HRManagers.dal.DAO;
import com.example.HRManagers.entities.Employee;
import java.sql.ResultSet;
import java.sql.SQLException;
import java.util.Vector;

public class EmpolyeeBO {
    /**
     *
    ...
    public int add(Employee e) {
        ...
        String sql = "INSERT INTO Employees(LastName, FirstName, BirthDate, HireDate, Address, City, Country, " +
                ...
                "', '" + cv.date2string(e.getBirthDate(), com.example.HRManagers.ValidData.EN_DATE) +
                "', '" + cv.date2string(e.getHireDate(), com.example.HRManagers.ValidData.EN_DATE) + "', '" +
    ...
    public int edit(Employee e) {
        ...
        String sql = "UPDATE Employees SET LastName='" + e.getLastName() + "', FirstName='" + e.getFirstName() +
                "', BirthDate='" + cv.date2string(e.getBirthDate(), com.example.HRManagers.ValidData.EN_DATE) +
                "', HireDate='" + cv.date2string(e.getHireDate(), com.example.HRManagers.ValidData.EN_DATE) +
