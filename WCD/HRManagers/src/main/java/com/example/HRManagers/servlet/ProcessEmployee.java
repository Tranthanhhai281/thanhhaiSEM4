...
import com.example.HRManagers.bol.EmpolyeeBO;
...
public class ProcessEmployee extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        EmpolyeeBO ebo = new com.example.HRManagers.bol.EmpolyeeBO();
        Employee e;
        ...
        if (action != null && action.equals("delete")) {
            ...
            e = new com.example.HRManagers.entities.Employee();
            com.example.HRManagers.ConvertData convert = new com.example.HRManagers.ConvertData();
