...
<div class="header">
    ...
    <div class="menu bubplastic horizontal orange">
        <ul>
            ...
            <li class="highlight"><span class="menu_r"><a href="ProcessEmployee"><span class="menu_ar">${pageScope.lB} Employee</span></a></span>
            </li>
        ...
        <form name="frmEmployee" method="post" action="ProcessEmployee" onsubmit="javascript:return check_submit()">
            ...
            <tr>
                <td colspan="2" align="center">
                    <center><input type="submit" value='${pageScope.lB}'></center>
                </td>
            </tr>
        </form>
    </table>
