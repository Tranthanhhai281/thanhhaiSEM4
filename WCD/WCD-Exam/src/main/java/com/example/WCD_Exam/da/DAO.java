package com.example.WCD_Exam.da;

import com.example.WCD_Exam.entity.Product;
import com.example.WCD_Exam.entity.User;
...
public class DAO {
    private static String jdbcURL = "jdbc:mysql://localhost:81/fdata?useLegacyDatetimeCode=false&serverTimezone=UTC";
